...
# p substrings("asdfcatqwer")

def subwords(word, dictionary)
  words_arr = []
  substring_arr = substrings(word)
  substring_arr.each do |word_in_substr|
    if dictionary.include?(word_in_substr)
      words_arr << word_in_substr
    end
  end
  words_arr
end
